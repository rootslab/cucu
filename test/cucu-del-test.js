...
var log = console.log
    ...
    , fn0 = function () {
        ...
        qq.stop( id0 );
        log( '- try #del operation with task, should return:', inspect( [ id0 ] ) );
        op = qq.del( id0 );
    ...
    , fn1 = function () {
        ...
        qq.stop( id1 );
        log( '- try #del operation with task, should return:', inspect( [ id1 ] ) );
        op = qq.del( id1 );
...
log( '- try #del operation with running tasks %s %s, should fail with:', inspect( id0 ), inspect( id1 ), inspect( -1 ) );
op = qq.del( id0 );
